...
export const isUserInfoLoaded = (state: RootState) =>
  getUserInfo(state).loading === LoadingState.SUCCESS;

export const isUserInfoLoading = (state: RootState) =>
  getUserInfo(state).loading === LoadingState.PENDING;
