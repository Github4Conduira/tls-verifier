import { computeBinderSuffix, packPresharedKeyExtension } from '../tls/client-hello'
import { readWithLength } from '../tls/packets'
import { verifyCertificateChain, verifyCertificateSignature } from '../tls/parse-certificate'
import { getPskFromTicket, parseSessionTicket } from '../tls/session-ticket'
import { TLSPresharedKey } from '../types'
import { computeSharedKeys, computeSharedMasterKey, loadX509FromPem } from '../utils'
import { bufferFromHexStringWithWhitespace, toHexStringWithWhitespace } from '../utils'

describe('Crypto Tests', () => {

	// test case from: https://tls13.xargs.org
	it('should correctly compute handshake keys', () => {
		const masterKey = computeSharedMasterKey(
	...
	it('should parse a session ticket correctly', () => {
		...
		const parsed = parseSessionTicket(
			...
			readWithLength(ticketPacked.slice(1), 3)
		)
	...
	it('should generate the correct resume handshake keys', () => {
		...
		const sharedkey = computeSharedMasterKey(
...

...

-----END CERTIFICATE-----`,
			),
			loadX509FromPem(`-----BEGIN CERTIFICATE-----
