...
import type { SUPPORTED_CIPHER_SUITE_MAP } from '../tls/constants';
import type { X509Certificate } from '../types/signatures';
...
export type TLSCrypto = {
    encrypt(cipherSuite: keyof typeof SUPPORTED_CIPHER_SUITE_MAP, opts: TLSCryptoCryptOptions): {
        ciphertext: Buffer;
        authTag: Buffer;
    };
    decrypt(cipherSuite: keyof typeof SUPPORTED_CIPHER_SUITE_MAP, opts: TLSCryptoCryptOptions): {
        plaintext: Buffer;
    };
};
